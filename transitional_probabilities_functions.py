...
def define_transitional_probabilities_functions (mortality_params_df_values, age, time):
    ...
    transitional_probability_expressions_pii=pd.Series()
    transitional_probability_expressions_pZi=pd.Series()
    transitional_probability_expressions_pZZ=pd.Series()
    ...
    transitional_probability_expressions_all=pd.concat([transitional_probability_expressions_pii,transitional_probability_expressions_pZi,transitional_probability_expressions_pZZ], axis=0)
  
    print(transitional_probability_expressions_all)
    pass
