...
#Creates an sympy equation for prevalence rate, with initial age group; sympify converts to a Sympy objecct
...
#Using the calculated initial stepwise intensities, build a dataframe object initial_calculated_probabilities to be used in premium calculation
...
#Creating a dataframe object to use later in calucations of premiums
    ...
    for illness in CRITICAL_ILLNESSES:
        ...
        pii_initial=sm.sympify(exp_df_second_age_group.at[illness,'pii'].loc[~exp_df_second_age_group.at[illness,'pii'].eq('')].at[illness])
        ...
        #the probabilities from x0+t1 up to x0+t2 we have already calculated in exp_df_second_age_group
