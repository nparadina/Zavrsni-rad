...
SELECT distinct [name_of_disease], code_MKB
	FROM [Critical Illness insurance].[dbo].[morbidity_per_age_group]

UPDATE [dbo].[morbidity_per_age_group]
...
UPDATE [dbo].[morbidity_per_age_group]
SET code_MKB='C16,C20,C33-C34,C50, C53, C81-C97, ostalo'
WHERE [name_of_disease] LIKE 'Ukupno zloćudne novotvorine%'
